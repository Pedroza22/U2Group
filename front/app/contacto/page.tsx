    ...
    <div className="min-h-screen bg-gray-50 neutra-font">
      ...
      <div className="bg-blue-600 text-white py-16">
        <div className="container mx-auto px-4">
          <div className="text-center">
            <h1 className="text-4xl md:text-5xl neutra-font-black mb-4">{t("contactUs") || "Contáctanos"}</h1>
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div>
            <h2 className="text-3xl neutra-font-bold text-gray-900 mb-8">{t("getInTouch") || "Ponte en Contacto"}</h2>
            ...
            <div className="bg-white rounded-lg p-6 shadow-lg">
              <h3 className="text-xl neutra-font-bold text-gray-900 mb-4">
                {t("whyChooseUs") || "¿Por qué elegirnos?"}
              </h3>
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  <div className="w-2 h-2 bg-blue-600 rounded-full mt-2"></div>
                  <span className="text-gray-700 neutra-font">{t("reason1") || "Más de 4 años de experiencia"}</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-2 h-2 bg-blue-600 rounded-full mt-2"></div>
                  <span className="text-gray-700 neutra-font">{t("reason2") || "Diseños personalizados y únicos"}</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-2 h-2 bg-blue-600 rounded-full mt-2"></div>
                  <span className="text-gray-700 neutra-font">{t("reason3") || "Equipo profesional y dedicado"}</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-2 h-2 bg-blue-600 rounded-full mt-2"></div>
                  <span className="text-gray-700 neutra-font">{t("reason4") || "Respuesta en 24 horas"}</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div>
            <Card className="p-8 shadow-lg">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  <label className="block text-sm neutra-font-bold text-gray-700 mb-2">
                    {t("projectLocation") || "Ubicación del Proyecto"}
                  </label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-sm neutra-font-bold text-gray-700 mb-2">
                    {t("projectTimeline") || "Cronograma del Proyecto"}
                  </label>
                  <select
                    name="timeline"
                    ...
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent neutra-font"
                  >
                    <option value="">{t("selectTimeline") || "Seleccionar cronograma"}</option>
                    <option value="asap">{t("asap") || "Lo antes posible"}</option>
                    <option value="3-months">{t("within3Months") || "Dentro de 3 meses"}</option>
                    <option value="6-months">{t("within6Months") || "Dentro de 6 meses"}</option>
                    <option value="1-year">{t("within1Year") || "Dentro de 1 año"}</option>
                    <option value="planning">{t("justPlanning") || "Solo planeando"}</option>
                  </select>
                </div>

                <div>
                  <label className="block text-sm neutra-font-bold text-gray-700 mb-2">
                    {t("additionalComments") || "Comentarios Adicionales"}
                  </label>
                  <textarea
                    name="comments"
                    ...
                    rows={4}
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent neutra-font"
                    placeholder={t("commentsPlaceholder") || "Cuéntanos más sobre tu proyecto..."}
                  />
                </div>
