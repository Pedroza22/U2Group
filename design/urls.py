...
urlpatterns = [
    path('marketplace/', MarketplaceView.as_view({'get': 'list', 'post': 'create'}), name='marketplace'),
    ...
    path('send-contact-message/', send_contact_message, name='send-contact-message'),
]